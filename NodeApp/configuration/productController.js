...
export { showProducts }//this will export the showProducts function so that we can use it in other files like routes.js where we will define the route for this function.